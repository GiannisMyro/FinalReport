...
Το λειτουργικό σύστημα που χρησιμοποήθηκε είναι το Ubuntu 1804, το οποίο ήταν εγκατεστημένο σε VirtualBox Manager 6.0 πάνω σε Windows 10. Για να είναι εφικτή η πραγματοποίηση των εργασιών έγινε εγκατάσταση των εφαρμογών python και asciinea ενώ για την υλοποίηση των εργασιών έγινε εγκατάσταση των εφαρμογών neofetch, ranger, thefuck, 
